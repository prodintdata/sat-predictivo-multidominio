...
CREATE TABLE `studentregistration` (
  ...
  `date_registration` bigint DEFAULT NULL,
  `date_unregistration` bigint DEFAULT NULL,
  PRIMARY KEY (`code_module`,`code_presentation`,`id_student`),
  CONSTRAINT `fk_registration_student` FOREIGN KEY (`code_module`, `code_presentation`, `id_student`) REFERENCES `studentinfo` (`code_module`, `code_presentation`, `id_student`) ON DELETE CASCADE ON UPDATE CASCADE
